...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    referendum_and_areas = pd.merge(
        regions_and_departments, referendum, left_on='code_dep',
        right_on='Department code', how='right')
...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    ...
    geo_data_frame_results = pd.merge(
        referendum_result_by_regions, geo_df, left_on='code_reg',
        right_on='code', how='left')

    geo_data_frame_results['ratio'] = geo_data_frame_results['Choice A'] / \
        (
        geo_data_frame_results['Choice A'] +
        geo_data_frame_results['Choice B'])

    geo_data_frame_results = gpd.GeoDataFrame(geo_data_frame_results)

    geo_data_frame_results.plot(column='ratio', legend=True)

    return geo_data_frame_results
