...
def merge_regions_and_departments(regions, departments):
    ...
    """
    df = pd.merge(departments[["region_code", "name", "code"]],
                  regions[["name", "code"]],
                  left_on="region_code", right_on="code")

    df = df.rename(columns={"region_code": "code_reg", "name_x": "name_dep",
                            "code_x": "code_dep", "name_y": "name_reg"})
